...
namespace ReModCE.Components
{
    internal sealed class MediaControlComponent : ModComponent
    {
        ...
        public override void OnUiManagerInitEarly()
        {
            ...
            {
                MelonLogger.Error($"Prevented UiManagerEarly in Media Control due to Nocturnal being loaded!");
            }
            else
            new Thread(() =>
            {
        ...
        public override void OnUiManagerInit(UiManager uiManager)
        {
            if (IsNocturnalLoaded)
            {
                MelonLogger.Error($"Prevented UiManager in Media Control due to Nocturnal being loaded!");
            }
            if (!IsNocturnalLoaded)
            {
