...
namespace ReModCE.Components
{
    internal class AvatarHistoryComponent : ModComponent, IAvatarListOwner
    {
        ...
        public AvatarHistoryComponent()
        {
            ...
            if (File.Exists("UserData/Odious/recent_avatars.bin"))
            {
                try
                {
                    _recentAvatars =
                        BinaryGZipSerializer.Deserialize("UserData/Odious/recent_avatars.bin") as List<ReAvatar>;
                }
                catch (GZipException e)
                {
                    ...
                    File.Delete("UserData/Odious/recent_avatars.bin.corrupted");
                    File.Move("UserData/Odious/recent_avatars.bin", "UserData/Odious/recent_avatars.bin.corrupted");
                }
            }
            else
            {
        ...
        {
            BinaryGZipSerializer.Serialize(_recentAvatars, "UserData/Odious/recent_avatars.bin");
        }
