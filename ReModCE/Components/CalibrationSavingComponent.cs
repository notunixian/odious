...
namespace ReModCE.Components
{
    internal class CalibrationSavingComponent : ModComponent
    {
        ...
        public CalibrationSavingComponent()
        {
            ...
            if (File.Exists("UserData/Odious/calibrations.json"))
            {
                _savedCalibrations =
                    JsonConvert.DeserializeObject<Dictionary<string, FbtCalibration>>(
                        File.ReadAllText("UserData/Odious/calibrations.json"));
            ...
            else
            {
                ...
                File.WriteAllText("UserData/Odious/calibrations.json", JsonConvert.SerializeObject(_savedCalibrations, Formatting.Indented, new JsonSerializerSettings
                {
        ...
        public override void OnUiManagerInit(UiManager uiManager)
        {
            ...
            menu.AddButton("Clear Saved Calibrations", "Clear your saved calibrations from your disk.", () =>
            {
                ...
                File.Delete("UserData/Odious/calibrations.json");
