...
namespace ReModCE.Components
{
    internal sealed class InstanceHistoryComponent : ModComponent
    {
        ...
        public InstanceHistoryComponent()
        {
            ...
            if (File.Exists("UserData/Odious/instance_history.json"))
            {
                _instanceHistory = JsonConvert.DeserializeObject<List<SavedWorld>>(File.ReadAllText("UserData/Odious/instance_history.json"));
            }
        ...
        public override void OnEnterWorld(ApiWorld world, ApiWorldInstance instance)
        {
            try
            {
                ...
                File.WriteAllText("UserData/Odious/instance_history.json", JsonConvert.SerializeObject(_instanceHistory));
